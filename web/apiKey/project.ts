...
export const KEY_PROJECT_VIEW = (project_id: TApiKey) => (project_id ? `KEY_PROJECT_VIEW${project_id}` : null);

export const KEY_PROJECT_VIEW_DETAIL = (project_id: TApiKey) => (project_id ? `KEY_PROJECT_VIEW_DETAIL${project_id}` : null);

export const KEY_PROJECT_PAGE = (project_id: TApiKey) => (project_id ? `KEY_PROJECT_PAGE${project_id}` : null);
