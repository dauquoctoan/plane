...
export const getConfigMoreIssue = (itemIssue: IIssue, pathName:string, dispatch: Dispatch<AnyAction>, noti:INotiConext | undefined, info: IInfo|null|undefined)=>{
    ...
    return  [
        {
            ...
            cb: ()=>{
                ...
                dispatch(modalSlice.actions.togleNewIssue({isDraft:false, isShow:true}));
            }
        },
        {
            text: 'Copy link',
        ...
        },
        {
            ...
            cb: ()=>{
                dispatch(modalSlice.actions.setIssue({name: itemIssue.name || '', description: itemIssue.description || ''}));
                dispatch(modalSlice.actions.togleNewIssue({isDraft:false, isShow:true}));
            }
        },
        {
