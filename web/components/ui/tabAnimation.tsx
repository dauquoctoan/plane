...
const TabAnimation: FC<ITabs> = ({ defaultTab = 1, option, onchange }) => {
  ...
  return (
    <div className="p-1 rounded border">
      <div
        ref={box}
        className="relative justify-between transition-all flex items-center"
      >
        ...
        <div
          ref={active}
          className="top-0 transition-all ease-in-out absolute h-full rounded bg-color-special-secondary"
        ></div>
      </div>
    </div>
  );
