...
import {
  CreateIssueViewFavoriteDto,
  UpdateIssueViewFavoriteDto,
} from '../dto/IssueViewFavorite.dto';
...
export class IssueViewFavoriteController {
  ...
  update(
    @Query('id') id: string,
    @Body() globalView: UpdateIssueViewFavoriteDto,
  ) {
    return handleResultSuccess(
      this.issueViewFavorite.updateById(id, globalView),
    );
  }
